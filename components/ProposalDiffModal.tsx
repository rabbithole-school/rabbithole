            ...
            <HStack gap={2}>
              ...
              {isUpdate ? (
                <Badge bg="orange.100" color="orange.700" fontSize="2xs" fontFamily="heading">
                  <PencilSimple style={{ display: "inline", marginRight: "2px" }} /> Update
                </Badge>
              ) : (
                <Badge bg="green.100" color="green.700" fontSize="2xs" fontFamily="heading">
                  <PlusCircle style={{ display: "inline", marginRight: "2px" }} /> Create
                </Badge>
              )}
            </HStack>
              ...
              {result ? (
                ...
                <VStack gap={4} align="stretch">
                  ...
                  <Box>
                    ...
                    >
                      <HStack gap={2}>
                        {showDirectives ? <CaretDown /> : <CaretRight />}
                        <Text fontWeight="600" fontFamily="heading" color="navy.500" fontSize="sm">
                  ...
                  <Box>
                    ...
                    >
                      <HStack gap={2}>
                        {showSeeds ? <CaretDown /> : <CaretRight />}
                        <Text fontWeight="600" fontFamily="heading" color="navy.500" fontSize="sm">
