...
function ScholarSessionInner() {
  ...
  // currentFocus is now an array of active class-focus pushes
  // (per-activity scheduling). The lock UI takes the first SOLO-STARTABLE one
  // as the "headline" focus — a focus the scholar can't complete on their own
  // (e.g. a card-sort done together in class) must NOT drive the read-only
  // lock (policy b, PR #707). Multi-card support lands in a later pass.
